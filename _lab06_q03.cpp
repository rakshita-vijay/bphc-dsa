...
class Maze{
  ...
  private:
    ...
    bool contains(string str, char toSearch);
    void pushUnvisited(int, int);
    friend ostream &operator<<(ostream &, const Maze &);
    int rows, cols;
};

bool Maze::contains(string str, char toSearch) {
...
void Maze::pushUnvisited(int row, int col){
    if (store[row][col] == passage or store[row][col] == exitMarker){
